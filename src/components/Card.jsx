...
export default function Card({ suit, rank, faceUp = true, onClick, disabled = false, selected = false, size = 'w-24 h-36' }) {
  ...
  return (
    <div
      ...
      className={`relative ${size} flex items-center justify-center overflow-hidden ${
        disabled ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110 transform transition-transform duration-150 cursor-pointer'
